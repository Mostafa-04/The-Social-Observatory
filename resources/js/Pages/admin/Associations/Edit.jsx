...
export default function Edit({
    ...
    */
    ...
    const existingLogo = association.logo_path
    ...
    */
    ...
    const existingCategoryIds =
        association.categories?.map((category) =>
            Number(category.id)
        ) ?? [];
    ...
    */
    ...
    const {
        ...
        social_links: {
            ...
            x: existingSocialLinks.x ?? "",
        },

        country_id:
            association.country_id ??
            association.country?.id ??
            "",
        ...
        data_source:
            association.data_source ?? "manual",
    ...
    */
    ...
    return (
        <AdminLayout>
            <Head
                title={`Modifier ${association.name}`}
            />
                ...
                <div className="mb-8 flex items-center justify-between gap-4">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-[13px] text-[#5B6462]">
                            ...
                            <span className="font-medium text-[#324949]">
                                "{association.name}"
                            </span>
                            .
                        </p>
                        ...
                        <div>
                            ...
                            <div className="grid items-start gap-6 sm:grid-cols-[auto_1fr]">
                                ...
                                <div>
                                    ...
                                    <p className="mt-1.5 max-w-28 text-[10px] leading-4 text-[#8A9290]">
                                        Laisser vide pour
                                        conserver le logo actuel.
                                    </p>
