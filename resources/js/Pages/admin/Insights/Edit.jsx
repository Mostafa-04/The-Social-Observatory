...
export default function Edit({ insight, categories, authors }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        published_at: insight.published_at
            ? insight.published_at.substring(0, 10)
            : "",
    });
    ...
    const submit = (e) => {
        ...
        post(route("insights.update", insight.id), {
            forceFormData: true,
        });
    };
                ...
                <div className="mb-8 flex items-center justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-[13px] text-[#5B6462]">
                            Modifier les informations de l'insight.
                        </p>
                    </div>
                ...
                <form onSubmit={submit}>
                    <div className="grid gap-6 lg:grid-cols-3">
                        ...
                        <div className="space-y-6 lg:col-span-2">
                            ...
                            {/* Featured image */}
                            <div className="rounded-xl border border-[#D6D9D8] bg-white p-6 shadow-sm space-y-4">
                                <label className={labelClass}>Image mise en avant</label>

                                {/* Current Image Preview */}
                                {insight.featured_image && (
                                    <div className="space-y-2">
                                        <p className="text-[12px] font-medium text-[#5B6462]">Image actuelle</p>
                                        <img
                                            src={`/storage/${insight.featured_image}`}
                                            alt={insight.title}
                                            className="h-48 w-72 rounded-lg border border-[#D6D9D8] object-cover"
                                        />
                                    </div>
                                )}
