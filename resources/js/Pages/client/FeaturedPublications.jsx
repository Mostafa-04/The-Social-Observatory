...
const FeaturedPublications = ({ publications = [] }) => {
  ...
  const isEmpty = !publications || publications.length === 0;
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 relative">
        ...
        {isEmpty ? (
          ...
          <div className="max-w-2xl mx-auto text-center py-12 px-8 rounded-2xl border border-dashed">
            <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-[#bf5429]/20 mb-5">
            ...
            <p className="text-sm text-white/60 leading-relaxed max-w-md mx-auto sm:mx-0">
              We haven't published anything yet, but new reports and briefs are on the way. Check back soon.
            </p>
          </div>
        ) : (
          /* Publications Grid */
